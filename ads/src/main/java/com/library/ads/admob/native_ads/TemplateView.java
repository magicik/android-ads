...
//    private static final String LARGE_TEMPLATE = "large_template";
...
//
//        Drawable mainBackground = styles.getMainBackgroundDrawable() != null ? styles.getMainBackgroundDrawable() : styles.getMainBackgroundColor();
...
//        } else {
//            adNotificationView.setVisibility(View.GONE);
//        }
//        if (cta != null) {
...
//        if (templateType == R.layout.template_view_medium_native_ads) {
//            return MEDIUM_TEMPLATE;
//        } else if (templateType == R.layout.template_view_small_native_ads) {
//            return SMALL_TEMPLATE;
//        } else if (templateType == R.layout.template_view_large_native_ads) {
...
//
//        try {
//            templateType = attributes.getResourceId(R.styleable.TemplateView_gnt_template_type, R.layout.template_view_medium_native_ads);
//        } finally {
//            attributes.recycle();
//        }
